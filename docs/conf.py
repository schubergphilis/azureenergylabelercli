...
# Read version directly from .VERSION file to avoid importing the package
# (which would require all dependencies to be installed)
try:
    version_file = project_root / "azureenergylabelercli" / ".VERSION"
    if not version_file.exists():
        version_file = project_root / ".VERSION"
    package_version = version_file.read_text(encoding="utf-8").strip()
except OSError:
...
# Note: html_theme_path is no longer needed for sphinx_rtd_theme
#html_theme_path = []
